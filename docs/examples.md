...
The same searchable namespace can back real apps and plug into agent frameworks.
See [Integrations](integrations.md) — the [Open Tag](integrations/open-tag.md)
Slack bot, plus [LangChain](integrations/langchain.md) and
[LangGraph](integrations/langgraph.md) adapters.
