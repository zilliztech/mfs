...
|---|---|---|---|---|
| Python | [`python/`](python) | `mfs_sdk` `0.4.1` | `python` with `urllib3` | [`python/docs/README.md`](python/docs/README.md) |
| TypeScript | [`typescript/`](typescript) | `@mfs/sdk` `0.4.1` | `typescript-fetch` | [`typescript/docs/README.md`](typescript/docs/README.md) |
