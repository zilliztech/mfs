...
*BrowseApi* | [**_export**](docs/BrowseApi.md#_export) | **GET** /v1/export | Export
*BrowseApi* | [**head**](docs/BrowseApi.md#head) | **GET** /v1/head | Head
*BrowseApi* | [**ls**](docs/BrowseApi.md#ls) | **GET** /v1/ls | Ls
*BrowseApi* | [**tail**](docs/BrowseApi.md#tail) | **GET** /v1/tail | Tail
*ConnectorsApi* | [**estimateConnector**](docs/ConnectorsApi.md#estimateconnector) | **POST** /v1/connectors/estimate | Estimate
*ConnectorsApi* | [**inspectConnector**](docs/ConnectorsApi.md#inspectconnector) | **GET** /v1/connectors/inspect | Inspect
*ConnectorsApi* | [**probeConnector**](docs/ConnectorsApi.md#probeconnector) | **POST** /v1/connectors/probe | Probe
*ConnectorsApi* | [**removeConnector**](docs/ConnectorsApi.md#removeconnector) | **DELETE** /v1/connectors | Remove
...
*IngestApi* | [**filesManifest**](docs/IngestApi.md#filesmanifest) | **POST** /v1/files/manifest | Files Manifest
*IngestApi* | [**filesUpload**](docs/IngestApi.md#filesupload) | **PUT** /v1/files/upload | Files Upload
*IngestApi* | [**getJob**](docs/IngestApi.md#getjob) | **GET** /v1/jobs/{job_id} | Job
*IngestApi* | [**listJobs**](docs/IngestApi.md#listjobs) | **GET** /v1/jobs | List Jobs
...
*ServerApi* | [**healthzHealthzGet**](docs/ServerApi.md#healthzhealthzget) | **GET** /healthz | Healthz
