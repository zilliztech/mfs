...
export class ServerApi extends runtime.BaseAPI {
     ...
     * Healthz
     */
    async healthzHealthzGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
     ...
     * Healthz
     */
    async healthzHealthzGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
