...
import io.zilliz.mfs.auth.Authentication;
import io.zilliz.mfs.auth.HttpBasicAuth;
import io.zilliz.mfs.auth.HttpBearerAuth;
import io.zilliz.mfs.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "http://127.0.0.1:8765";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://127.0.0.1:8765)
     ...
     * @return a {@link io.zilliz.mfs.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.zilliz.mfs.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.zilliz.mfs.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.zilliz.mfs.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.zilliz.mfs.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.zilliz.mfs.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.zilliz.mfs.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.zilliz.mfs.ApiException If fails to update the parameters
     */
     ...
     * @throws io.zilliz.mfs.ApiException If fail to serialize the request body object into a string
     */
