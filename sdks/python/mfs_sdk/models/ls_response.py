...
class LsResponse(BaseModel):
    ...
    capabilities: Optional[Dict[str, Any]] = Field(default=None, description="connector capabilities (sync/object)")
    __properties: ClassVar[List[str]] = ["entries", "capabilities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [LsEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
