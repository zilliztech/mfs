...
class StatusResponse(BaseModel):
    ...
    jobs: Optional[Dict[str, StrictInt]] = Field(default=None, description="count of jobs by status")
    __properties: ClassVar[List[str]] = ["connectors", "jobs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connectors": [ConnectorRow.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None,
            "jobs": obj.get("jobs")
        })
        return _obj
