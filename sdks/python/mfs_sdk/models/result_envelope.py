...
class ResultEnvelope(BaseModel):
    ...
    locator: Optional[Dict[str, Any]] = Field(default=None, description="per-chunk identity. body/code/document chunks: {'lines':[start,end]}; structured (DB row, issue, slack thread): connector PK dict (e.g. {'id':1}, {'number':42}, {'thread_ts':'...'}); once-per-object kinds: null.")
